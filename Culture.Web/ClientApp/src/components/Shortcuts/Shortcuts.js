    ...
    render() {
        return (
            <div className="card mb-3" >
                <h5 className="card-header text-center" style={{ backgroundColor: "#efffed" }}>Skróty</h5>
                <ul className="list-group list-group-flush">
                    ...
                    <div  onClick={this.props.handleClick}>
                        <li name="mapa" className="list-group-item liHover "><span className="fas fa-map-marked-alt mr-2 fa-2x mapStyle" ></span>Moja mapa </li>
                    </div>
                    <div onClick={this.props.handleClick}>
